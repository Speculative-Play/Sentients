...
export const AppProvider = (props) => {
  ...
  const SAMColorPalette = {
    user_chat_bubble: darkmode ? "#a60029" : "#f6bd60",
    AI_chat_bubble: darkmode ? "#a10256" : "#f5cac3",
  ...
  const SAMFonts = {
    ...
    ThinItalic: "RobotoMono_100Thin_Italic",
    ExtraLightItalic: "RobotoMono_200ExtraLight_Italic",
    LightItalic: "RobotoMono_300Light_Italic",
    RegularItalic: "RobotoMono_400Regular_Italic",
    MediumItalic: "RobotoMono_500Medium_Italic",
    SemiBoldItalic: "RobotoMono_600SemiBold_Italic",
    BoldItalic: "RobotoMono_700Bold_Italic",
  };
